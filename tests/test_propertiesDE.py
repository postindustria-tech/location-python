...
pipeline = LocationPipelineBuilder(resource_key = resource_key, location_provider = "digitalelement").build()

location_engine = pipeline.get_element("location_digitalelement")
